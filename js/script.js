...
const typingText = document.querySelector("div.typing-text p#paragraph");
const inpField = document.querySelector("div.wrapper input.input-field")
const tryAgainBtn = document.querySelector("div.content button");
const timeTag = document.querySelector("li.time span b");
const mistakeTag = document.querySelector("li.mistake span");
const wpmTag = document.querySelector("li.wpm span");
const cpmTag = document.querySelector("li.cpm span");
